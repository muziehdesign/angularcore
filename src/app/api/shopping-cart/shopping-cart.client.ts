...
export class ShoppingCartClient {
    ...
    getCustomers(): Observable<PagedResponse<CustomerResponse>> {
        return this.http.get<PagedResponse<CustomerResponse>>(`${this.config.shoppingCartApi?.url}/api/v1/customers`, {context: new HttpContext().set(AUTHENTICATED_REQUEST, true)});
    }
}
